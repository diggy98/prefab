    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">PREFAB HOMES</h3>
            <div className="grid grid-cols-3 gap-4 mt-6">
              <div>
                <h4 className="text-sm text-gray-400 mb-3">Links</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">Guarantees</a></li>
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">Offices</a></li>
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">Media</a></li>
                </ul>
              </div>
              <div>
                <h4 className="text-sm text-gray-400 mb-3">Company</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">About Us</a></li>
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">Prefab Homes</a></li>
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">Energy Efficiency</a></li>
                </ul>
              </div>
              <div>
                <h4 className="text-sm text-gray-400 mb-3">Support</h4>
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="text-sm hover:text-primary transition-colors">Resources</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div>
            <div className="flex flex-col items-start md:items-end">
              <p className="text-primary text-lg mb-2">+44-798-5602627</p>
              <p className="text-sm text-gray-400 mb-6">Mon-Fri: 8:00-17:00</p>
