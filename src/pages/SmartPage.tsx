  ...
  return (
    <div className="pt-20">
        ...
        <div className="absolute inset-0 flex items-center justify-start z-20">
          <div className="container mx-auto px-4">
            <div className="max-w-2xl">
              <div className="text-blue-400 text-sm uppercase tracking-wider mb-4">SMART COLLECTION</div>
              <h1 className="text-5xl md:text-6xl text-white font-light mb-6 leading-tight">
                Intelligent Living
                <span className="relative">
                  <div className="absolute -bottom-2 left-0 w-8 h-8 border-2 border-blue-400 rounded-sm"></div>
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  href="#models" 
                  className="inline-block bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 font-medium transition-colors duration-200 rounded-sm"
                >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="text-blue-600 text-sm uppercase tracking-wider mb-4">SMART TECHNOLOGY</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="bg-blue-600/10 w-20 h-20 rounded-lg flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
      ...
      <section id="models" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="text-blue-400 text-sm uppercase tracking-wider mb-4">SMART MODELS</div>
                  ...
                  <div className="relative overflow-hidden bg-gray-800 transition-all duration-500 hover:bg-gray-750 rounded-lg">
                    ...
                    <div className="relative overflow-hidden h-80">
                      ...
                      <div className="absolute top-6 left-6">
                        <div className="bg-blue-600 text-white py-2 px-4 text-sm font-medium rounded-sm">
                          SMART
                        </div>
                      </div>
                    ...
                    {/* Content */}
                    <div className="p-8">
                      <h3 className="text-white text-2xl font-light mb-3 group-hover:text-blue-400 transition-colors duration-300">
                        {house.name}
                      </h3>
                      ...
                      <Link 
                        ...
                        className="block w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 font-medium transition-colors duration-200 text-center rounded-sm"
                      >
                        View Details &rarr;
                      </Link>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-blue-600 px-8 py-3 font-medium hover:bg-gray-100 transition-colors duration-200 rounded-sm">
              Schedule Demo
            </button>
            <Link 
              to="/gallery"
              className="border border-white text-white px-8 py-3 font-medium hover:bg-white hover:text-blue-600 transition-colors duration-200 rounded-sm"
            >
              View All Models
            </Link>
          </div>
