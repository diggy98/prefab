      ...
      <section className="relative h-96 bg-gradient-to-r from-purple-600 to-purple-800">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white">
            <h1 className="text-5xl font-light mb-4">Modern-B Collection</h1>
            <p className="text-xl mb-6 max-w-2xl">
              Contemporary architecture with bold design elements. Our Modern-B series features 
              striking facades and innovative architectural solutions for the modern lifestyle.
            </p>
            <div className="flex items-center space-x-4">
              <span className="bg-white text-purple-600 px-4 py-2 font-medium">
                {modernBHouses.length} Model Available
              </span>
              <span className="text-white/80">Starting from £340,000</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Bold Architecture</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Contemporary Style</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-light text-gray-800 mb-6">Modern-B Models</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover our Modern-B collection, featuring bold contemporary architecture 
            ...
            {modernBHouses.map((house, index) => {
              ...
              return (
                <div key={index} className="group relative overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-500">
                  ...
                  {/* Modern-B Badge */}
                  <div className="absolute top-4 right-4 z-10 bg-purple-600 text-white py-1 px-3 text-xs font-medium">
                    MODERN-B
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-bold text-purple-600 text-lg">£{house.price.toLocaleString()}</span>
                      </div>
                    </div>
      ...
      <section className="py-20 bg-purple-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Experience contemporary architecture at its finest with our Modern-B collection's 
            striking designs and innovative features.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-purple-600 px-8 py-3 font-medium hover:bg-gray-100 transition-colors duration-200">
              Schedule Consultation
            </button>
            <Link 
              to="/gallery"
              className="border border-white text-white px-8 py-3 font-medium hover:bg-white hover:text-purple-600 transition-colors duration-200"
            >
              View All Models
            </Link>
          </div>
